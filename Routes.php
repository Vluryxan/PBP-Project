...
$routes->get('sayuran', 'Sayuran::index');
$routes->get('sayuran/tambah', 'Sayuran::tambah');
$routes->post('sayuran/simpan', 'Sayuran::simpan');
...
$routes->get('/asisten', 'AsistenController::simpan');
